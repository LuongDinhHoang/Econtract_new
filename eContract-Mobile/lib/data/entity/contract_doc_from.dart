...
class ContractDocFrom extends ContractDocs
    implements Insertable<ContractDocFrom> {
  ContractDocFrom(
      {String? contractGuid,
      String? contractName,
  ...
  ContractDocFrom.fromJson(Map<String, dynamic> json, String userId)
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    return ContractDocsFromTableCompanion(
            ...
            typeSign: Value(typeSign.toString())
            )
